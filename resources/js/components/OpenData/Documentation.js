...
const jsonExample = {
        ...
        descripcion_lugar: "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s",
        tipo: "Secuestros",
        municipio: "TORIBIO",
        departamento: "CAUCA",
        audio: {
    ...
    render() {
        return (
            <Segment basic className="no-padding margin-top-20">
            	<Header as="h3">Documentación de API</Header>
            	<p>
            		El api de testimonios le permitirá acceder, desde otros sistemas,
            		a los testimonios de las víctimas del conflicto armado que tenemos
            		almacenados.
            	</p>
            	...
            	<ul>
            		<li>
            			<strong>busqueda:</strong> (String) Filtro de busqueda por texto. Este parametro filtra los resultados de la consulta,
            			 retornando todos los testimonios donde el texto de busqueda se encuentre en el título, descripción corta, descripción detallada o descripción del lugar del testimonio.
            		</li>

            		<li>
            			<strong>tipo:</strong> (Enum) Filtro de busqueda por tipo de testimonio. Este parametro filtra los resultados de la consulta,
            	...
            	<ul>
            		...
            		<li>
            			<strong>descripcion_lugar*: </strong>(String) Descripción breve del lugar donde ocurrieron los hechos del testimonio.
            		</li>
            		<li>
