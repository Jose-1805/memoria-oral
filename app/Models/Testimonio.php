...
class Testimonio extends Model
{
    ...
    public static function rules(Request $request){
    	...
    	$data = [
	        ...
	        'descripcion_lugar' => 'required|min:50|max:150',
	        //'latitud',
	        //'longitud',
	        ...
	        //annexos
	        'descripcion_detallada' => 'nullable|required_without_all:audio,video,anexos|min:1000|max:20000',
	        'audio' => 'nullable|file|mimetypes:audio/mpeg,audio/webm,video/webm|max:204800|required_without_all:descripcion_detallada,video,anexos',
	        'video' => 'nullable|file|mimetypes:video/mp4,video/ogg|max:2048000|required_without_all:descripcion_detallada,audio,anexos',
	        'anexos' => 'nullable|required_without_all:descripcion_detallada,audio,video',
	    ];
        ...
        if($testimonio){
            ...
            if(
                ...
                $data['audio'] = 'file|mimetypes:audio/mpeg,audio/webm,video/webm|max:10240';
                $data['video'] = 'file|mimetypes:video/mp4,video/ogg|max:20480';
                $data['anexos'] = '';
            }
        }
